class SecurityView {
	getMarkup() {
		return `
			<h1 class="border-bottom border-secondary text-primary-emphasis py-2 mb-0">Security</h1>
			<div class="row">
				<div class="h-20 col-md-3 d-none d-md-flex fw-bold">
					<nav class="navbar flex-column justify-content-start w-100 border-end">
						...
						<hr class="w-100 border">
						<a href="./security.html" class="nav-link w-100 p-2  bg-body-tertiary border-start border-primary border-4 text-primary">
							<div class="d-flex align-items-center ps-1">
