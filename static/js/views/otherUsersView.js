class OtherUsersView {
	getMarkup() {
		return `
			<h1 class="border-bottom border-secondary text-primary-emphasis py-2 mb-0">Other Users</h1>
			<div class="row">
				<div class="h-20 col-md-3 d-none d-md-flex fw-bold text-primary-emphasis">
					<nav class="navbar flex-column justify-content-start w-100 border-end">
						...
						<a href="./dashboard.html" class="nav-link w-100 p-2">
							<div class="d-flex align-items-center ps-1">
						...
						<a href="./other_users.html" class="nav-link w-100 p-2 bg-body-tertiary border-start border-primary border-4 text-primary">
							<div class="d-flex align-items-center ps-1">
				...
				<div class="col-12 col-md-9 mt-3">
					<h2 class="pt-2 text-primary-emphasis">Search Users</h2>
					...
					<div class="row">
						...
						<div class="table-container col-12 col-lg-6 border ps-0">
					...
					<ul>
						...
						</li><li>They cannot contact you via Zong chat.
						</li><li>You cannot contact the user via Zong chat.</li>
					</ul>
					<div class="row">
						<div class="col-12 col-lg-6 mb-4">
							<form method="POST" action="/block-user">
