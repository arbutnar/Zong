			...
			<div class="banners-cont container-fluid row">
				<div class="col-12 col-sm-6 p-0 pb-2 pb-sm-0 pe-sm-2">
					<a href="/tournament" data-link>
						<div class="banner locked position-relative">
							<div class="tornament_overlay overlay img-fluid w-100 d-flex flex-column justify-content-center align-items-center text-white">
				...
				<div class="col-12 col-sm-6 p-0">
					<div class="col-12 pb-2">
						<a href="/versus" data-link>
							<div class="banner locked position-relative">
								<div class="versus_overlay overlay img-fluid w-100 d-flex flex-column justify-content-center align-items-center text-white">
					...
					<div class="col-12">
						<a href="/practice" data-link>
							<div class="banner unlocked position-relative">
								<div class="practice_overlay overlay img-fluid d-flex flex-column justify-content-center align-items-center text-white">
