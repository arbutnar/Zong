class MessagesView {
	getMarkup() {
		return `
			<h1 class="border-bottom border-secondary text-primary-emphasis py-2 mb-0">Messages</h1>
			<div class="row">
				<div class="col-md-3 d-none d-md-flex fw-bold text-primary-emphasis">
					<nav class="navbar flex-column justify-content-start w-100 border-end">
						...
						<a href="./other_users.html" class="nav-link w-100 p-2">
							...
							<a href="./messages.html" class="nav-link w-100 p-2 bg-body-tertiary border-start border-primary border-4 text-primary">
							<div class="d-flex align-items-center ps-1">
