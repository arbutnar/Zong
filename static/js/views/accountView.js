class AccountView {
	getMarkup() {
		return `
			<h1 class="border-bottom border-secondary text-primary-emphasis py-2 mb-0">Account</h1>
			<div class="row">
				<div class="col-md-3 d-none d-md-flex fw-bold text-primary-emphasis">
					<nav class="navbar flex-column justify-content-start w-100 border-end">
						<a href="./account.html" class="nav-link w-100 p-2 bg-body-tertiary border-start border-primary border-4 text-primary">
				...
				<div class="col-12 col-md-9 mt-3">
					<h2 class="pt-2 text-primary-emphasis">mabasset</h2>
					<div class="row py-2">
					...
					<div class="row py-2">
						...
						<div class="col-12 col-md-8 col-xl-9 text-primary-emphasis fs-5 fw-light text-truncate">
							<span>matte.bassetto01@gmail.com</span>
						</div>
					</div>
					<hr>
					<div class="row py-2">
